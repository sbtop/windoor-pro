...
import { Settings, Save, CheckCircle2, RefreshCw, Ruler, Box, Package, User, Building2, Globe, ShieldCheck, Mail } from 'lucide-react';
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    ...
                                    disabled
                                    className="w-full pl-12 pr-6 py-4 bg-slate-50/50 border-2 border-slate-100 rounded-2xl font-bold text-slate-300 cursor-not-allowed"
                                />
                            </div>
                        </div>
                    </div>
